...
struct t2fs_superbloco {
	...
	WORD    superblockSize; 	/* O superbloco ocupa o primeiro bloco do disco, isso �, o bloco zero. */
	...
	DWORD   diskSize;		/* Quantidade total de blocos na parti��o T2FS. Inclui o superbloco, �reas de bitmap, �rea de i-node e blocos de dados */
};
